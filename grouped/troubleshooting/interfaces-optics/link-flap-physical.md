...
## Source: `formatted/TS_notes/BUG_Hold-time_down_không_hoạt_động_được_nếu_cấu_hình_nhỏ_hơn_1s_trên_interface_chạy_WANPHY.md`
...
## Source: `formatted/TS_notes/Delay_thời_gian_up_time_của_CE_interfaces.md`
...
## Source: `formatted/TS_notes/Lệnh_off_laser_mode_shell_<<<_dùng_flap_link.md`
...
SMPC4(MX960-01_RE1 vty)# test ifd xe-4/1/1 laser off 5000
[Jul  5 08:58:36.115 LOG: Debug] xe-4/1/1: turn off laser for 5000 msec, then turn on laser
[Jul  5 08:58:36.619 LOG: Info] ifp xe-4/1/1 ifd_mdown: 186954054 ms
