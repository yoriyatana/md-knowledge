# L3VPN Architecture, Interprovider & Label Allocation

> Generated deterministically from the approved grouping manifest.


## Source: `formatted/Learning_Notes/Untitled Note_4.md`
...
- Local customer edge ID: assigned by PE router for each site within a customer VPN. Configure ‘**site-identifier**’ inside [edit routing-options  protocols l2vpn site].
...
- Inside [edit routing-instances  protocols] configure **‘l2vpn encapsulation-type frame-relay’**
...
# <https://www.inetzero.com/blog/interprovider-layer-3-vpn-option-c-2/>

## Source: `formatted/Learning_Notes/L3VPN per-prefix label allocation.md`

# L3VPN per-prefix label allocation

![](../../assets/concepts/f62ee564a1-6b3824d06382c3469b9886c43ae97fc3.png)

## Source: `formatted/Learning_Notes/l3vpn hub and spoke.md`
...
## Source: `formatted/Learning_Notes/l3vpn hub and spoke_2.md`
...
## Source: `formatted/Learning_Notes/Untitled Note_3.md`
...
From <<http://www.juniper.net/techpubs/en_US/junos14.2/topics/reference/configuration-statement/multipath-edit-routing-options.html>>
