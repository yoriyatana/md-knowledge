...
[![](../../assets/mpls-ldp-labels/07e26c48bf-0018d7d9cd094b3c7004ba211e706c22.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-3.png)Note: To override those default parameters you can use those following commands:

[![](../../assets/mpls-ldp-labels/dcd544dbf2-b3b8fa0848870df564768e4b6169d465.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-9.png)

[2] PE1 and P1 establish between them a TCP session and start to exchange the LDP session parameters:

[![](../../assets/mpls-ldp-labels/2c5f00e6e9-46f6d30146ca06af992ff423aff94ec5.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-4.png)
...
[![](../../assets/mpls-ldp-labels/35cc4be8c5-0b90d9d776a9b292c2f28666b78574e2.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-10.png)
...
[![](../../assets/mpls-ldp-labels/6a5707c116-eff14548d757016110e7c0d95c16afbf.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-5.png)
...
[![](../../assets/mpls-ldp-labels/c36d09e4cd-72f85189de830e569cb77e0b46ac692b.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-6.png)
...
[![](../../assets/mpls-ldp-labels/fc7a58d517-d5a1003fda0c0fbcdac4f75efbc587f2.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-7.png)
...
[![](../../assets/mpls-ldp-labels/8c8dd2d9cc-a50ec60c64e5af1915f1f4b076f2389e.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-8.png)Great! LDP is now synchronised between PE1 and P1. You can use the following commands to check all that we seen previously by analysing LDP packets:

Check LDP Discovery/Session on PE1:

[![](../../assets/mpls-ldp-labels/96a9762331-2fab0157d62b553c2097538dce06f042.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-11.png)Note: if the LDP neighbour comes down (UDP discovery phase,I mean.) the LDP session will be also shutdown automatically and all Label Mapping associated to this session will be released. In case of ECMP between 2 routers, you can have multiple UDP neighbours adjacencies (one per interface) but you will still have only one LDP TCP session. In case of ECMP, to shutdown automatically the TCP session the router wait to have lost all the neighbour discovery adjacencies before with the peer router.

Check LDP Database on PE1:

[![](../../assets/mpls-ldp-labels/4b6a1841ea-bc273e50b20ffe8e59d39e83aebd9f15.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-12.png)And finally check LDP routes (remember LDP routes are put in the inet.3 table)

[![](../../assets/mpls-ldp-labels/1ff4d91793-a956e8461b2102891c73a3b78b0f2ed7.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-13.png)
...
[![](../../assets/mpls-ldp-labels/f5033e3643-19ed1ddf82d019257306166f5668417f.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-142.png)Then call back the command to check the inet.3 routing table. Great! As you can see know LDP metrics are mapped to IGP metrics.

[![](../../assets/mpls-ldp-labels/e4138c2352-e506f183715f8ac897180d17063a505c.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-151.png)
...
[![](../../assets/mpls-ldp-labels/b85a508100-dcbc9ba59285d80ed7a7f4e5561dc289.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-183.png)Commit this and then check LDP Database of PE1:

[![](../../assets/mpls-ldp-labels/a33bd46b21-340a0e6070e4f294f2d38fac6bf215a2.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-23.png)Great! Now PE1 maps a label to its Secondary Lo0 address.
...
[![](../../assets/mpls-ldp-labels/3ef1f005c7-50d68996b9165030d19aec1dd370eb88.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-26.png)By default, Junos aggregates in a single FEC. Let’s check on P1 its LDP database:

[![](../../assets/mpls-ldp-labels/9b5834dfe8-2f36f4e1aaa4b4f96998dc60d7c9176e.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-27.png)As you can see, P1 receives from PE1 2 EGRESS IP addresses (map to implicit null label 3 because PE1 is egress PE for those 2 addresses), but the most interesting part is the label allocated back by P1 for those 2 addresses. As you can see, P1 “aggregates” the 2 IPs addresses in a single FEC and allocates the same label (299856).

Now let’s try to configure the deaggregate knob on P1 like that:

[![](../../assets/mpls-ldp-labels/40957c594c-235cfd21dab7eecdc370c68db21eec7c.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-28.png)and have a look gain on P1 LDP database:

[![](../../assets/mpls-ldp-labels/99444d3c1e-386a9961a3c49427942f52d41d2ff263.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-29.png)
...
[![](../../assets/mpls-ldp-labels/40e76505ee-491ffb9211b788648e25aec4442a780d.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-30.png)Now, you can check on PE1 the LDP Database and the inet.3 table:

[![](../../assets/mpls-ldp-labels/a0d4173818-6fc05c2d0cf240ed6e6863584a470ee5.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp31-.png)Now P1 allocates a label of 0 for its primary loopback address. To reach the P1 Next-hop, PE1 will explicitly push the label 0.
...
[![](../../assets/mpls-ldp-labels/e6db9baa41-6a4fcc6e9440506e86d0736b592f0ab8.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-32.png)Now we disable LDP on P1 but we keep OSPF UP. On P2 the LDP session comes down:

[![](../../assets/mpls-ldp-labels/a3c0b725cd-0bf5673e621d9a52297e8f539fb76c64.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-33.png)Let’s check the P2 OSPF LSAs – you can see that the adjacency of P1 is now assigned to an infinite metric. The “show route ” confirms also the right behaviour:

[![](../../assets/mpls-ldp-labels/e289e29476-ce3f43ffe5174a0af2d77e8988fe7fdd.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-34.png)
...
[![](../../assets/mpls-ldp-labels/3a1381adac-1c120fc52c6b7e97f6e39c52805c6478.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-35.png)Note: you can specify the number of seconds before the LDP session is torn down and resignaled. To do that, use the parameter “timeout” behind the session-protection knob.

Now we can check back the LDP Discovery adjacencies on PE2:

[![](../../assets/mpls-ldp-labels/8bb7996b97-e69530714442021d241271af6fd08b8f.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-36.png)
...
[![](../../assets/mpls-ldp-labels/d60ac2d651-2cf4ec57e40546c4a512c838aab44a10.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-37.png)Now, check back, LDP Discovery adj. LDP session and LDP database on PE2:

[![](../../assets/mpls-ldp-labels/03f6ae0470-b3c72649203c6ed8e43fe3999b6a4578.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-38.png)Great, all works as expected. Only the classical/Direct Discovery adjacency between PE2 and P2 has disappeared. The Lo0 Discovery Adj stays up, because targeted hellos are sent through the “backup” path PE2P3P2 (possible because TTL is upper than 1 in this case). The LDP TCP session between PE2 and P2 is still up and the database has not been flushed. when link between PE2 / P2 will come back up only the direct discovery adj. will be re-established and that all, PE2 and P2 will be already synchronized.
...
![](../../assets/mpls-ldp-labels/0c7b3a3b66-7af8427f0febe8c680e563f2cb17087a.png)
...
![](../../assets/mpls-ldp-labels/8849943331-b05ab21b38d63bb848f02e3b5d5fc87c.png)![](../../assets/mpls-ldp-labels/5833b3f150-de97ae7cccc6357a1c1a11a9669511b9.png)![](../../assets/mpls-ldp-labels/f832ba5862-69f318ba9d5f4d77b83d3f01147d9dd7.png)
