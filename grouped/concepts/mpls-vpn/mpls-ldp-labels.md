...
## Source: `formatted/TS_notes/Label_usage.md`
...
## Source: `formatted/classification/Concepts_Theory/No_more_doubt_with_LDP.md`

# No more doubt with LDP

[https://www.inetzero.com/no-more-doubt-about-ldp/](https://www.inetzero.com/no-more-doubt-about-ldp/)
...
[![e64dd97d311f08e1158056e6290402ca.png](../../assets/mpls-ldp-labels/60d0c71033-e64dd97d311f08e1158056e6290402ca.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-1.png)

As you can see, each router has 2 loopback addresses. The basic configuration of each router is the following:

[![b758a0dd1992948251108cafce1b9bff.png](../../assets/mpls-ldp-labels/4f66c02ea1-b758a0dd1992948251108cafce1b9bff.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-2.png)

The first analysis that we are going to cover is the LDP neighbour discovery and session establishment. On Point to Point links, I mean, between 2 adjacent routers, an LDP router discovers its neighbours by sending periodic multicast LDP Hello Discovery messages (based on UDP protocol port 646). Once 2 routers see each other as neighbour, they start to establish a TCP session (Port 646). This TCP session will be then used to exchange FEC/Label Mapping.
...
[![0018d7d9cd094b3c7004ba211e706c22.png](../../assets/mpls-ldp-labels/90a5826a92-0018d7d9cd094b3c7004ba211e706c22.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-3.png)

Note: To override those default parameters you can use those following commands:

[![b3b8fa0848870df564768e4b6169d465.png](../../assets/mpls-ldp-labels/4562142aef-b3b8fa0848870df564768e4b6169d465.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-9.png)

* *[2]** PE1 and P1 establish between them a TCP session and start to exchange the LDP session parameters:

[![46f6d30146ca06af992ff423aff94ec5.png](../../assets/mpls-ldp-labels/c15f20f7b8-46f6d30146ca06af992ff423aff94ec5.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-4.png)
...
[![0b90d9d776a9b292c2f28666b78574e2.png](../../assets/mpls-ldp-labels/9ea4a3eefb-0b90d9d776a9b292c2f28666b78574e2.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-10.png)
...
[![eff14548d757016110e7c0d95c16afbf.png](../../assets/mpls-ldp-labels/018b75ec79-eff14548d757016110e7c0d95c16afbf.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-5.png)
...
[![72f85189de830e569cb77e0b46ac692b.png](../../assets/mpls-ldp-labels/77841a330e-72f85189de830e569cb77e0b46ac692b.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-6.png)
...
[![d5a1003fda0c0fbcdac4f75efbc587f2.png](../../assets/mpls-ldp-labels/5a8f92e009-d5a1003fda0c0fbcdac4f75efbc587f2.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-7.png)
...
[![a50ec60c64e5af1915f1f4b076f2389e.png](../../assets/mpls-ldp-labels/e9dadc8002-a50ec60c64e5af1915f1f4b076f2389e.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-8.png)

Great! LDP is now synchronised between PE1 and P1. You can use the following commands to check all that we seen previously by analysing LDP packets:

Check LDP Discovery/Session on PE1:

[![2fab0157d62b553c2097538dce06f042.png](../../assets/mpls-ldp-labels/ce526e92c7-2fab0157d62b553c2097538dce06f042.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-11.png)

Note: if the LDP neighbour comes down (UDP discovery phase,I mean.) the LDP session will be also shutdown automatically and all Label Mapping associated to this session will be released. In case of ECMP between 2 routers, you can have multiple UDP neighbours adjacencies (one per interface) but you will still have only one LDP TCP session. In case of ECMP, to shutdown automatically the TCP session the router wait to have lost all the neighbour discovery adjacencies before with the peer router.

Check LDP Database on PE1:

[![bc273e50b20ffe8e59d39e83aebd9f15.png](../../assets/mpls-ldp-labels/e2f432a52a-bc273e50b20ffe8e59d39e83aebd9f15.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-12.png)

And finally check LDP routes (remember LDP routes are put in the inet.3 table)

[![a956e8461b2102891c73a3b78b0f2ed7.png](../../assets/mpls-ldp-labels/a4e6b6d0b5-a956e8461b2102891c73a3b78b0f2ed7.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-13.png)
...
[![19ed1ddf82d019257306166f5668417f.png](../../assets/mpls-ldp-labels/8e23502c35-19ed1ddf82d019257306166f5668417f.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-142.png)

Then call back the command to check the inet.3 routing table. Great! As you can see know LDP metrics are mapped to IGP metrics.

[![e506f183715f8ac897180d17063a505c.png](../../assets/mpls-ldp-labels/9a631aa64a-e506f183715f8ac897180d17063a505c.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-151.png)
...
[![dcbc9ba59285d80ed7a7f4e5561dc289.png](../../assets/mpls-ldp-labels/76e555e2f0-dcbc9ba59285d80ed7a7f4e5561dc289.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-183.png)

Commit this and then check LDP Database of PE1:

[![340a0e6070e4f294f2d38fac6bf215a2.png](../../assets/mpls-ldp-labels/114902e910-340a0e6070e4f294f2d38fac6bf215a2.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-23.png)

Great! Now PE1 maps a label to its Secondary Lo0 address.
...
[![399618e58888dcd04231156c6b2afe93.png](../../assets/mpls-ldp-labels/938036f29f-399618e58888dcd04231156c6b2afe93.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-24.png)

The term2 reject all other routes that do not match the range 192.167.2.0/24 (remember the default import policy is accept all). No let’s commit this configuration on PE1 and check again the LDP database of this router:

[![3d5a542d078afd3293e1bd700d3f39c4.png](../../assets/mpls-ldp-labels/36cc338dd7-3d5a542d078afd3293e1bd700d3f39c4.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-25.png)

The result is quite different with an Export policy. Indeed, as only PE1 advertises its Secondary address, the Label Mapping received from P1 concerns only Primary Addresses, except the PE1 label mapping sent back by P1. So, all those routes are filtered. This is also why PE1 sends only its Egress FEC. It can’t allocate a Label Mapping for a FEC that it didn’t receive and accept a Label mapping from a downstream router before. In this case the PE1 inet.3 routing table will be empty.
...
[![50d68996b9165030d19aec1dd370eb88.png](../../assets/mpls-ldp-labels/ad183e8834-50d68996b9165030d19aec1dd370eb88.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-26.png)

By default, Junos aggregates in a single FEC. Let’s check on P1 its LDP database:

[![2f36f4e1aaa4b4f96998dc60d7c9176e.png](../../assets/mpls-ldp-labels/ca64cab160-2f36f4e1aaa4b4f96998dc60d7c9176e.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-27.png)

As you can see, P1 receives from PE1 2 EGRESS IP addresses (map to implicit null label 3 because PE1 is egress PE for those 2 addresses), but the most interesting part is the label allocated back by P1 for those 2 addresses. As you can see, P1 “aggregates” the 2 IPs addresses in a single FEC and allocates the same label (299856).

Now let’s try to configure the deaggregate knob on P1 like that:

[![235cfd21dab7eecdc370c68db21eec7c.png](../../assets/mpls-ldp-labels/08f6ae1b47-235cfd21dab7eecdc370c68db21eec7c.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-28.png)

and have a look gain on P1 LDP database:

[![386a9961a3c49427942f52d41d2ff263.png](../../assets/mpls-ldp-labels/e39e881c79-386a9961a3c49427942f52d41d2ff263.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-29.png)
...
[![491ffb9211b788648e25aec4442a780d.png](../../assets/mpls-ldp-labels/5606f372d6-491ffb9211b788648e25aec4442a780d.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-30.png)

Now, you can check on PE1 the LDP Database and the inet.3 table:

[![6fc05c2d0cf240ed6e6863584a470ee5.png](../../assets/mpls-ldp-labels/598ab56b85-6fc05c2d0cf240ed6e6863584a470ee5.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp31-.png)

Now P1 allocates a label of 0 for its primary loopback address. To reach the P1 Next-hop, PE1 will explicitly push the label 0.
...
[![6a4fcc6e9440506e86d0736b592f0ab8.png](../../assets/mpls-ldp-labels/2f1374bcfe-6a4fcc6e9440506e86d0736b592f0ab8.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-32.png)

Now we disable LDP on P1 but we keep OSPF UP. On P2 the LDP session comes down:

[![0bf5673e621d9a52297e8f539fb76c64.png](../../assets/mpls-ldp-labels/6d611bab2d-0bf5673e621d9a52297e8f539fb76c64.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-33.png)

Let’s check the P2 OSPF LSAs – you can see that the adjacency of P1 is now assigned to an infinite metric. The “show route ” confirms also the right behaviour:

[![ce3f43ffe5174a0af2d77e8988fe7fdd.png](../../assets/mpls-ldp-labels/25e1c3503c-ce3f43ffe5174a0af2d77e8988fe7fdd.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-34.png)
...
[![1c120fc52c6b7e97f6e39c52805c6478.png](../../assets/mpls-ldp-labels/9d268724be-1c120fc52c6b7e97f6e39c52805c6478.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-35.png)

Note: you can specify the number of seconds before the LDP session is torn down and resignaled. To do that, use the parameter “timeout” behind the session-protection knob.

Now we can check back the LDP Discovery adjacencies on PE2:

[![e69530714442021d241271af6fd08b8f.png](../../assets/mpls-ldp-labels/e0e3e33c15-e69530714442021d241271af6fd08b8f.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-36.png)
...
[![2cf4ec57e40546c4a512c838aab44a10.png](../../assets/mpls-ldp-labels/3f36612d37-2cf4ec57e40546c4a512c838aab44a10.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-37.png)

Now, check back, LDP Discovery adj. LDP session and LDP database on PE2:

[![b3c72649203c6ed8e43fe3999b6a4578.png](../../assets/mpls-ldp-labels/72d5ed12dd-b3c72649203c6ed8e43fe3999b6a4578.png)](http://inetzero.com/wp-content/uploads/2014/06/ldp-38.png)

Great, all works as expected. Only the classical/Direct Discovery adjacency between PE2 and P2 has disappeared. The Lo0 Discovery Adj stays up, because targeted hellos are sent through the “backup” path PE2P3P2 (possible because TTL is upper than 1 in this case). The LDP TCP session between PE2 and P2 is still up and the database has not been flushed. when link between PE2 / P2 will come back up only the direct discovery adj. will be re-established and that all, PE2 and P2 will be already synchronized.
...
## Source: `formatted/classification/Concepts_Theory/LDP-tunnelling_and_hidden_routes_in_inet-3.md`

# LDP-tunnelling and hidden routes in inet.3

![7af8427f0febe8c680e563f2cb17087a.png](../../assets/mpls-ldp-labels/5fca5f5e29-7af8427f0febe8c680e563f2cb17087a.png)

## Source: `formatted/TS_notes/ldp-tunneling_or_BGP-LU_(swap_label_0_behavior_change_from_19-x.md`

# ldp-tunneling or BGP-LU (swap label 0 behavior change from 19.x

![image.png](../../assets/mpls-ldp-labels/50bd5b1924-image.png)

![image-1.png](../../assets/mpls-ldp-labels/4d8c8dfcb9-image-1.png)

![image-2.png](../../assets/mpls-ldp-labels/390aa8ca76-image-2.png)
