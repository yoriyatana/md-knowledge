...
## Source: `formatted/classification/Concepts_Theory/Address-Assignment_Pools_for_Subscriber_Management.md`

# Untitled Note

# Address-Assignment Pools for Subscriber Management

![534eebdc7ca8e2e42e26eb6110ef24ed.png](../../assets/bras-overview/f4eccdb82c-534eebdc7ca8e2e42e26eb6110ef24ed.png)
...
<span style="background-color: #ffaaaa"><<< Thông tin như bên dưới được hiểu sẽ là so sánh giữa link-pool và không link-pool.</span>
```
...
labroot@jtac-mx960-r2024-re0# run show network-access aaa statistics address-assignment pool ftth_private routing-instance VRF_CGNAT

Address assignment statistics

Pool Name: ftth_private

Link Name: ftth_private_1
