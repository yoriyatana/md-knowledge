...
[edit groups interface-family interfaces  unit 0]
...
+ policy-statement EXPORT\_OSPF\_CE\_C1 {
...
+ policy-statement EXPORT\_VRF\_C1 {
...
+ policy-statement IMPORT\_VRF\_C1 {
...
+ vrf-import IMPORT\_VRF\_C1;

+ vrf-export EXPORT\_VRF\_C1;
...
+ policy-statement EXPORT\_OSPF\_C1 {
...
+ policy-statement EXPORT\_OSPF\_C2\_S2 {
...
+ inactive: export EXPORT\_OSPF\_C2\_S2;
...
+ policy-statement EXPORT\_OSPF\_C2\_S1 {
...
+ inactive: export EXPORT\_OSPF\_C2\_S1;
...
+ policy-statement EXPORT\_BGP\_R11 {
...
+ policy-statement IMPORT\_BGP\_R11 {

+ term CHANGE\_COMM\_C2 {
...
+ policy-statement EXPORT\_VRF\_C3\_S1\_HUB {
...
+ community add C3\_HUB;

+ community add C3\_ORIGIN\_R1;
...
+ policy-statement IMPORT\_VRF\_C3\_S1\_SPOKE {
...
+ community C3\_HUB members target:123:31;

+ community C3\_ORIGIN\_R1 members origin:10.210.1.1:1;

+ community C3\_SPOKE members target:123:32;
...
+ vrf-export EXPORT\_VRF\_C3\_S1\_HUB;
...
+ route 0.0.0.0/0 policy GEN\_DEFAULT;
...
+ vrf-import IMPORT\_VRF\_C3\_S1\_SPOKE;
...
+ policy-statement EXPORT\_BGP\_C3\_S1\_2 {
...
+ community C3\_ORIGIN\_R2 members origin:10.210.1.2:1;
...
+ policy-statement EXPORT\_VRF\_C3\_SPOKE {

+ term 1 {

+ then {

+ community add C3\_SPOKE;

+ community add C3\_ORIGIN\_R4;
...
+ policy-statement IMPORT\_VRF\_C3\_SPOKE {
...
+ community C3\_ORIGIN\_R4 members origin:10.210.1.4:1;
...
+ vrf-import IMPORT\_VRF\_C3\_SPOKE;

+ vrf-export EXPORT\_VRF\_C3\_SPOKE;
...
+ community C3\_ORIGIN\_R5 members origin:10.210.1.5:1;

+ community C3\_ORIGIN\_R6 members origin:10.210.1.6:1;
...
+ policy-statement EXPORT\_VRF\_C3\_S1\_SPOKE {
...
+ policy-statement IMPORT\_BGP\_C3 {
...
[edit routing-instances C3-hub protocols bgp group C3\_S1]

+ keep all;

+ import IMPORT\_BGP\_C3;
...
+ vrf-export EXPORT\_VRF\_C3\_S1\_SPOKE;
...
[edit policy-options policy-statement IMPORT\_VRF\_C3\_SPOKE]
...
+ egress-policy EGRESS\_POLICY\_LDP;

[edit policy-options]

+ policy-statement EGRESS\_POLICY\_LDP {
...
[edit policy-options policy-statement EXPORT\_VRF\_C3\_SPOKE term 1 then]

community add C3\_ORIGIN\_R6 { ... }

+ community add C3\_R6;

[edit policy-options policy-statement IMPORT\_VRF\_C1]
...
+ community C3\_R6 members target:123:36;
