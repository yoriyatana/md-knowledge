...
[http://junosandme.over-blog.com/article-trio-card-packet-capture-pfe-commands-115251441.html](http://junosandme.over-blog.com/article-trio-card-packet-capture-pfe-commands-115251441.html)
...
Trio based cards offer a lot of interesting shell commands. I found a set of commands that allow you to capture and display (in hexa mode) transit traffic _(with some restrictions)_
...
![5d28333f60c53b8f872901817f0a3b24.png](image/5d28333f60c53b8f872901817f0a3b24.png)

* *_Steps to capture traffic:_**
...
test jnh **<pfe-instance>** packet-via-dmem enable **<buffer>**

- --

<buffer> is optional. I never tuned it and always used the default configuration.
...
Jan 11 15:16:11  ncdib101 fpc4 LUCHIP(1) PPE_7 Errors lmem addr error
...
0x3 means capture m2l pkt and pkt_head
...
![](http://fdata.over-blog.com/pics/smiles/icon_biggrin.gif)).  After many tests I've deduced that you have to remove the first 16 bytes for MPLS traffic and 20 bytes for IP traffic. After that you have your packet. In my previous capture that is MPLS traffic:
