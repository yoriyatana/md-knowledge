...
- Based on the Dijkstra algorithm
    ...
    - Candidate database
    - Tree database
- <span style="background-color: #ffaaaa">Runs on a per-level</span> basis on each router
...
- TLVs 2, 128, and 130 use 6 bits for metric values
    - <span style="background-color: #ffaaaa">Maximum metric</span> for an interface is <span style="background-color: #ffaaaa">63</span>
    - Configured metrics larger than the maximum value are advertised as 63
        - The largest value possible for this <span style="background-color: #ffaaaa">total metric cost is 1023</span>
...
- The default operation of IS-IS is to <span style="background-color: #ffaaaa">advertise both the small and wide metric TLVs in all LSPs</span>
...
- <span style="background-color: #ffaaaa">Per-interface authentication</span> affects <span style="background-color: #ffaaaa">hello PDUs only</span> and takes precedence over per-level settings

![59a41de793f71dd13050349a2bad46c0.png](image/59a41de793f71dd13050349a2bad46c0.png)
...
![108a9786a38d7447408cdc9aa03467b0.png](image/108a9786a38d7447408cdc9aa03467b0.png)
...
![e8497c8ea044fe09fc4f22d0cd113b0c.png](image/e8497c8ea044fe09fc4f22d0cd113b0c.png)
