...
- Routes advertised from an L2 area into an L1 area have the up/down bit set to down

- Ensures that another L2 router will not re-advertise the route back into an L2 area to avoid routing loops

![](image/78976ce143532fc8a2e11f5db6a1142a.png)
...
1) L1 internal routes are advertised to both L1 and L2 neighbors
