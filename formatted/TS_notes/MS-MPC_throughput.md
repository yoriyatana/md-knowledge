...
_Note: về mặt kỹ thuật, Junos version không ảnh hưởng đến scaling throughput của card MS-MPC, đây chỉ là cách mà SVTECH chúng ta đang thống nhất với các anh Juniper VN để truyền thông ra cho Viettel._
