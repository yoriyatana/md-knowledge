...
+ log interactive-commands (Hoặc các file log có ghi log facility là interactive-commands) - match "UI_CMDLINE_READ_LINE: User '"
...
- Cách check liên quan đến thay đổi phần cứng:
 ...
 + log chassisd (sẽ có các keyword  "CHASSISD_SNMP_TRAP.*FRU")
