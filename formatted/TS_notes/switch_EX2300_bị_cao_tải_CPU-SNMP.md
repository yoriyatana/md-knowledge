...
|Jun   7 02:00:03  SW_ACC_IDC_44 dc-pfe:  LBCM-L2,brcm_irb_egress_cntr_get(),8609:brcm_irb_egress_cntr_get Failed to get vlan id  4294967295 for ifl index 545

Jun   7 02:00:03  SW_ACC_IDC_44 fpc0  LBCM-L2,brcm_irb_egress_cntr_get(),8609:brcm_irb_egress_cntr_get Failed to get vlan id  4294967295 for ifl index 545

Jun   7 02:00:14  SW_ACC_IDC_44 dc-pfe:  LBCM-L2,brcm_irb_egress_cntr_get(),8609:brcm_irb_egress_cntr_get Failed to get vlan id  4294967295 for ifl index 545

Jun   7 02:00:14  SW_ACC_IDC_44 fpc0  LBCM-L2,brcm_irb_egress_cntr_get(),8609:brcm_irb_egress_cntr_get Failed to get vlan id 4294967295  for ifl index 545

……
Jun   7 02:00:00 SW_ACC_IDC_44 newsyslog[45251]: logfile turned over due to  size>1024K|
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
junos:19.1R1
The error has no  functional impact and is fixed in the following releases:|
|------------------------------------------------------------------------------------------------------------------------------------------|
...
ifd(non  ae)      7947951                45.75

ifd(ae)               49034                     94.07

ifl(non  ae)        3232866                 536.86

ifl(ae)                94716                     615.76

firewall              0                             0.00
root@SW_ACC_IDC_44>  show snmp stats-response-statistics |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
- Trong thời gian lên kế hoạch upgarde, để tạm thời giảm CPU thiết bị, SVTECH đề xuất cấu hình lại thông tin trên SNMP server đối với SW_ACC_44: chỉ lấy thông tin các interface cần thiết (các interface có cấu hình và đang chạy dịch vụ), tránh việc gửi nhận thông tin pseudo interface gây cao tải.
