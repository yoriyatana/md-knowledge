...
[https://kb.juniper.net/InfoCenter/index?page=content&id=KB29446&act=login](https://kb.juniper.net/InfoCenter/index?page=content&id=KB29446&act=login)
...
jnxFruOfflineReason appears in CHASSISD_SNMP_TRAP10 messages.

CHASSISD_SNMP_TRAP10 is an SNMP trap message. It is found in the chassisid file when a field-replaceable unit (FRU) goes offline.
...
```
Aug 26 08:52:45 CHASSISD_SNMP_TRAP10: SNMP trap generated: FRU power off
