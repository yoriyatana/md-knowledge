...
2. Nguyên nhân CPU cao thất thường trên MPC5E: do từ version 15.1R5 trở đi PPE rebalance service trên linecard được enab và khi nó xử lý sẽ làm CPU của linecard tăng cao, tuy nhiên đây chỉ là harmless và expected behavior
...
3. Advance TAC khuyến nghị giám sát CPU của linecard thông qua OID/MIB lấy giá trị trung bình. Thông tin OID/MIB giám sát giá trị trung bình:
...
| 1 | 1 Minute average | jnxOperating1MinAvgCPU | 1.3.6.1.4.1.2636.3.1.13.1.23.7.x.0 |
| 2 | 5 Minute average | jnxOperating1MinAvgCPU | 1.3.6.1.4.1.2636.3.1.13.1.24.7.x.0 |
| 3 | 15 Minutes average | jnxOperating1MinAvgCPU | 1.3.6.1.4.1.2636.3.1.13.1.25.7.x.0 |
