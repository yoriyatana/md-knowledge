...
|  |
| --- |
| juniper@HNI-RR-ALL-RE0> show system firmware  Jun 01 16:33:44  Routing Engine 0 RE i40e-NVM       7   4.26      0         OK  Routing Engine 1                   0   0.53.1    0         OK |
...
|  |
| --- |
| Last login: Tue Jun  1 06:56:49 2021 from re1  --- JUNOS 18.4R3-S4.2 Kernel 64-bit  JNPR-11.0-20200618.2bc7e35\_buil  root@RR-VNPT-LAB\_RE0:~ # cli  NVM\_version: 04.26  DRV\_version: 1.1.23  ERROR: i40e NVM firmware is not compatible ,please upgrade i40e NVM before installing this package  ERROR: Aborting the installation  1  ERROR: Upgrade failed |

2. Junos OS hỗ trợ firmware 6.01
...
<https://www.juniper.net/documentation/us/en/software/junos/junos-install-upgrade/topics/task/vmhost-nvm-upgrade.html> ==>Table 1
...
<https://drive.google.com/drive/folders/1trobaxb3ykO9fzxHBKrn1ZglRc0bl-lp?usp=sharing>

<https://drive.google.com/drive/u/2/folders/1VacZ9BtJtOCYghRX0zZcPBkbvVpIPqle>
...
|  |
| --- |
| root@RR-VNPT-LAB\_RE0> show system firmware | match i40  Routing Engine 0 RE i40e-NVM       7   6.1                   6.01                  OK |
