...
Khi một interface mới được tạo ra, mib2d sẽ tự động kiểm tra và cấp phát SNMP Ifindex cho interface đó và lưu vào trong database file */var/db/dcd.snmp_ix*
...
[ June 13, 2023 15:30 ] ⁨SVT.Ngọc.NĐ⁩: không rõ, nếu mình lấy backup file  /var/db/dcd.snmp_ix ra trước, rồi sau khi thay RE xong, thì chép đè file này vào lại RE mới thì lúc đó giám sát theo thông tin cũ còn ok ko nhỉ?
