# route-reflector outside the PE (out of path)

# [https://github.com/rendoaw/notes/blob/master/juniper/junos.route.resolution.md](https://github.com/rendoaw/notes/blob/master/juniper/junos.route.resolution.md)

## Problem

It is common that people configure route-reflector outside the PE, either on dedicated router or on the P router. Those type of routers sometime doesn't have lsp configured (in rsvp-based network) or even may not running mpls at all.
...
- [http://www.juniper.net/documentation/en_US/junos14.1/topics/example/vpns-layer-3-route-resolution-route-reflector.html](http://www.juniper.net/documentation/en_US/junos14.1/topics/example/vpns-layer-3-route-resolution-route-reflector.html)
- [http://blog.inetsix.net/2012/09/junos-as-pe-with-route-reflector-to-learn-vpn/](http://blog.inetsix.net/2012/09/junos-as-pe-with-route-reflector-to-learn-vpn/)
- [http://www.gossamer-threads.com/lists/nsp/juniper/54404](http://www.gossamer-threads.com/lists/nsp/juniper/54404)

---

- [https://www.inetzero.com/blog/junos-os-route-reflection-considerations/](https://www.inetzero.com/blog/junos-os-route-reflection-considerations/)
