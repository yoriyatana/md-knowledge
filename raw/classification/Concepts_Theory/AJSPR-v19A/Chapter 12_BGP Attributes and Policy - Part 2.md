...
- **always-compare-med** compares MEDvalues, regardless of whether the neighboring AS is the same
...
- Represented in decimal form of *AS:number* (for example: 200:123)
...
community  members [community-id community-id];
