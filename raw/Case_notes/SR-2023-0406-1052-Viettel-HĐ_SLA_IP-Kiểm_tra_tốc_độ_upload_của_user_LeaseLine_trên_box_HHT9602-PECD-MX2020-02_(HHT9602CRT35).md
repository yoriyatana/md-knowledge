...
                PC_DNI_test2 (đã check thời điểm OK thì out ra theo ae31 và ae32 đều OK)
...
Gi0/3                          up             up       d061_ll_namcttth_test2  ###Line bổ sung thêm
Gi0/5                          down           down     d061_ll_namcttth_test   ###Line ban đầu <<< hiện đang down do không cắm PC
```
...
description d061_ll_namcttth_test
no ip address
...
  service-policy input d061_ll_namcttth_test
...
description d061_ll_namcttth_test2
no ip address
negotiation auto
storm-control broadcast level pps 10
storm-control unicast level pps 10
...
  encapsulation untagged
  service-policy input d061_ll_namcttth_test2
...
ethernet oam
service-policy input Trust_Ingress
service-policy output Queuing_Egress
...
       DNI8001AGG01_TO_CTDNI8001        10.216.255.1          up  up
       DNI8001AGG01_TO_CTDNI8002        10.216.255.2          up  up
```
...
  Signalled-Name: DNI8002AGG01_TO_CTDNI8001
  Status:
    Admin:    up Oper:   up   Path:  valid   Signalling: connected

    path option 1,  type explicit DNI8002AGG01_TO_CTDNI8001 (Basis for Setup, path weight 10500)
...
    path option 2,  type explicit DNI8002AGG01_TO_CTDNI8001_BACKUP (Basis for Standby, path weight 12000)
...
  Signalled-Name: DNI8002AGG01_TO_CTDNI8002
  Status:
    Admin:    up Oper:   up   Path:  valid   Signalling: connected

    path option 1,  type explicit DNI8002AGG01_TO_CTDNI8002 (Basis for Setup, path weight 10000)
      Protected-by PO index: 2
    path option 2,  type explicit DNI8002AGG01_TO_CTDNI8002_BACKUP (Basis for Standby, path weight 12500)
    G-PID: 0x0800 (derived from egress interface properties)
    Bandwidth Requested: 0 kbps  CT0
    Creation Time: Tue Jul  9 00:35:53 2019 (3y45w ago)
  Config Parameters:
...
Building configuration...
  bridge-domain d061_ll_namcttth_test
   mac
    secure
     action none
     logging
...
Building configuration...
  bridge-domain d061_ll_namcttth_test2
   mac
    secure
     action none
     logging
...
-------------------------------- ----- -------------- ------------ ------------- ----------- -----------
L3LL:d061_ll_namcttth_test       274   up             0/0          3/1           0/0         0/0        
L3LL:d061_ll_namcttth_test2      275   up             0/0          3/2           0/0         0/0        
```

```
RP/0/RSP0/CPU0:DNI8002AGG03#show l2vpn bridge-domain detail | begin d061_ll_namcttth_test2
Mon May 22 11:42:39.887 Hanoi
Bridge group: L3LL, bridge-domain: d061_ll_namcttth_test2, id: 275, state: up, ShgId: 0, MSTi: 0
...
        Label        45558                          37                            
        Group ID     0x113                          0x0                           
        Interface    Access PW                      d061_ll_namcttth_test2        
        MTU          9000                           9000                          
...
RP/0/RSP0/CPU0:DNI8002AGG03#show l2vpn bridge-domain detail | begin d061_ll_namcttth_test
Mon May 22 11:58:16.985 Hanoi
Bridge group: L3LL, bridge-domain: d061_ll_namcttth_test, id: 274, state: up, ShgId: 0, MSTi: 0
  Coupled state: disabled
  VINE state: Default
  MAC learning: enabled
  MAC withdraw: enabled
...
        Label        104875                         93                            
        Group ID     0x112                          0x0                           
        Interface    Access PW                      d061_ll_namcttth_test         
        MTU          9000                           9000                          
        Control word disabled                       disabled                      
        PW type      Ethernet                       Ethernet                      
        VCCV CV type 0x2                            0x2                           
...
![75437703d27a24fd42cecc1142f7741e.png](image/75437703d27a24fd42cecc1142f7741e.png)

show cef 27.68.254.110

1. **Trạng thái irb vpls circuit kênh đang test**

Trạng thái L2circuit, VPLS trên srt và agg là up 3 tuần

```
{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show vpls connections instance d061_ll_namcttth_test | no-more
...
Instance: d061_ll_namcttth_test
  VPLS-id: 990001865
...
        Description: Intf - vpls d061_ll_namcttth_test neighbor 10.216.255.10 vpls-id 990001865
...
        Description: Intf - vpls d061_ll_namcttth_test neighbor 10.216.255.9 vpls-id 990001865
      Flow Label Transmit: No, Flow Label Receive: No

pmgatepro@HHT9602.PECD.MX2020.02_RE0> show vpls connections instance d061_ll_namcttth_test2 | no-more
Layer-2 VPN connections:
...
Instance: d061_ll_namcttth_test2
  VPLS-id: 990001892
  Mesh-group connections: AGGs
    Neighbor                  Type  St     Time last up          # Up trans
...
        Description: Intf - vpls d061_ll_namcttth_test2 neighbor 10.216.255.9 vpls-id 990001892
      Flow Label Transmit: No, Flow Label Receive: No
...
        Description: Intf - vpls d061_ll_namcttth_test2 neighbor 10.216.255.10 vpls-id 990001892
      Flow Label Transmit: No, Flow Label Receive: No
```

```
{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show vpls mac-table instance d061_ll_namcttth_test | no-more

{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show vpls mac-table instance d061_ll_namcttth_test2 | no-more

MAC flags       (S -static MAC, D -dynamic MAC, L -locally learned, C -Control MAC
    O -OVSDB MAC, SE -Statistics enabled, NM -Non configured MAC, R -Remote PE MAC, P -Pinned MAC)

Routing instance : d061_ll_namcttth_test2
Bridging domain : __d061_ll_namcttth_test2__, VLAN : none
...
```
{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show interfaces irb.4646
May 22 11:50:19
  Logical interface irb.4646 (Index 12273) (SNMP ifIndex 20299)
    Description: d061_ll_namcttth_test2_Master
    Flags: Up SNMP-Traps 0x4000 Encapsulation: ENET2
    Bandwidth: 1Gbps
    Routing Instance: d061_ll_namcttth_test2 Bridging Domain: None
...
{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show interfaces irb.4646 extensive
May 22 11:50:27
...
```
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show interfaces irb.4637
May 22 12:01:08
  Logical interface irb.4637 (Index 12184) (SNMP ifIndex 20276)
    Description: d061_ll_namcttth_test_Master
    Flags: Up SNMP-Traps 0x4000 Encapsulation: ENET2
    Bandwidth: 1Gbps
    Routing Instance: d061_ll_namcttth_test Bridging Domain: None
...
{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show interfaces irb.4637 detail
May 22 12:01:12
...
      Flags: Sendbcast-pkt-to-re
      Input Filters: d061_ll_namcttth_test_UPLOAD-irb.4637-i
      Output Filters: d061_ll_namcttth_test_DOWNLOAD-irb.4637-o
      Addresses, Flags: Is-Preferred Is-Primary
...
      Policer: Input: ARP_POLICER-irb.4637-inet-arp

{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show interfaces irb.4637 extensive
May 22 12:01:16
  Logical interface irb.4637 (Index 12184) (SNMP ifIndex 20276) (Generation 27158)
    Description: d061_ll_namcttth_test_Master
    Flags: Up SNMP-Traps 0x4000 Encapsulation: ENET2
...
```
{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show pfe statistics traffic
May 22 12:36:41
...
```
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show pfe statistics traffic    | match "input|ouput|drop"
Packet Forwarding Engine traffic statistics:
...
{master}
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show pfe statistics traffic detail | no-more
May 22 12:38:16
...
```
pmgatepro@HHT9602.PECD.MX2020.02_RE0> show chassis fpc
May 22 12:39:47
...
1. **Kết quả traceroute từ client đến server speedtest đang test**

1. Show route forwarding **27.68.201.1 trên cả 2 PECD**

1. Kiểm tra scale irb up, firewall filter, số lượng term, kiem tra các linecard uplink
...
1. Healthcheck resouce box giữa2 cặp PECD (N4 và N6)
