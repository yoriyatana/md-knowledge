...
```
request support information | no-more | save /var/log/RSI_ME_PR01.SOF055_20220316
file archive source /var/log/* destination /var/tmp/LOG_ME_PR01.SOF055_20220316
```
...
```
{master}
vietpn@ME_PR01.SOF055_RE1> show chassis hardware models
Hardware inventory:
...
```
{master}
vietpn@ME_PR01.SOF055_RE1> show configuration interfaces | display set | match "[geax][et]-1"     
set interfaces xe-1/0/0 apply-groups-except MTU
set interfaces xe-1/0/0 description TO_AR01.INH085_Xe-1/0/0
...
set interfaces xe-1/1/0 description To_ME_PR01_ZAM034_XE-0/2/0_NEW_LINK
set interfaces xe-1/1/0 framing wan-phy
set interfaces xe-1/1/0 gigether-options 802.3ad ae4
set interfaces ge-1/2/0 description 3G_HUB:TO_OSN3500:_SL14/P1
...
set interfaces ge-1/2/1 description 3G_HUB:TO_OSN3500:_SL14/P2
...
set interfaces ge-1/2/2 description 3G_HUB:TO_OSN3500:_SL14/P3
...
set interfaces ge-1/2/3 description 3G_HUB:TO_OSN3500:_SL14/P4
...
set interfaces ge-1/3/0 description FOR_SWITCH_SOF055
...
set interfaces ge-1/3/1 description TO_AR04.SOF089_Ge-0/2/0_Via:XDM_I13/P1_BACKUP
...
set interfaces ge-1/3/2 description TO_AR04.SOF089_Ge-0/2/1_Via:XDM_I13/P2_BACKUP
...
set interfaces ge-1/3/4 description TO_ME_SOF055SRT01
set interfaces ge-1/3/4 gigether-options 802.3ad ae10
set interfaces ge-1/3/5 apply-groups-except MTU
set interfaces ge-1/3/5 description TO_ME_SOF086SRT01
...
```
request support information | no-more | save /var/log/RSI_ME_PR01.SOF055_20220128
file archive source /var/log/* destination /var/tmp/LOG_ME_PR01.SOF055_20220128
```
...
{master}
vietpn@ME_PR01.SOF055_RE1> show chassis alarms
...
{master}
vietpn@ME_PR01.SOF055_RE1> show chassis hardware
Hardware inventory:
...
```
{master}
longnh@ME_AR02.SOF033_RE0> show chassis hardware | no-more
Hardware inventory:
Item             Version  Part number  Serial number     Description
